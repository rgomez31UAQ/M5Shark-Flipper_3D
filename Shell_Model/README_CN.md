...
**4、透明版本，请选择[4_Small_Coli_Transparent](./4_Small_Coli_Transparent)**
<sub>*这个目录包括3个零件：顶部壳体、底部壳体、按键。*</sub>
...
**5、内置天线版本，请选择[5_Internal_antenna](./5_Internal_antenna)**
<sub>*这个目录包括四个零件：顶部壳体、底部壳体、按键、导光柱。*</sub>
![Step_9](./Step/Step_9.jpg)
虽然通过SMA接口可以自由的搭配需要的天线，但是如果你希望自己的设备更加小巧，可以尝试这一版本，将天线隐藏在设备内部，需要注意，这样会导致射频性能变差，距离变短。
在基础版本上，去除左侧的SMA天线口，适当调整了侧面的红外窗口尺寸，除此之外，与基础版本相同。
要想使用内部天线，你需要对PCB进行一些改造，首先需要购买一个433MHz弹簧天线，这是推荐的尺寸和购买链接：
![ant](./Step/ant.jpg)
[淘宝购买链接](https://item.taobao.com/item.htm?id=649004376195)
你也可以根据自己的需求选择，如果使用315MHz更加频繁，也可以使用315MHz的天线，以获得最佳效果。另外，建议购买带有热缩管保护套的天线。

你需要使用按照《拆卸及组装说明》将PCB取出，然后将原本的SMA天线座替换为上面这款小型天线,将天线垂直焊接到PCB背面即可。
![ant1](./Step/ant1.jpg)
